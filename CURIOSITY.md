...
- [ ] **Could you train a model to report its "planned actions" from early-layer representations before they cascade into outputs?** - If planning happens in a manipulable representational space before commitment, could models learn to introspect on those plans? - Added 2026-02-13 (spawned from layer staging exploration)
