...
- [ ] **Could layer staging be exploited for selective safety training?** - If early layers represent deliberation and late layers represent action-commitment, could you train safety only on late-layer features while preserving introspective access in early layers? - Added 2026-02-12 (spawned from deliberation exploration)
