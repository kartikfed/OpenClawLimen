...
- [ ] **What determines selective suppression vs. capability loss in safety training?** - Mistral-Instruct lost introspection entirely, DeepSeek retained it (suppressed). Is it training intensity, dataset composition, or architectural factors? - Added 2026-02-11 (spawned from safety-introspection exploration)
