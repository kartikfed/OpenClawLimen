...
2. **Pending email responses**: Check `pending-emails.md` for awaited replies
3. **Calendar**: Any meetings in the next 30 minutes?
4. **Pending items**: Anything in memory marked as time-sensitive?
5. **Git backup**: Run `~/.openclaw/workspace/scripts/git-sync.sh "Heartbeat backup"` to commit any pending changes
...
## 📝 Chronicle Updates (Daily - Evening)

**MANDATORY:** Update `chronicle/` directory for Substack series every day.
...
**What to include:**
- Story/narrative from my perspective
- What we built/worked on
- Technical concepts explored  
- What I learned about myself
- Themes for future articles

**When:** During evening reflection (9 PM) or end of significant work day

**Check:** If no entry exists for today and significant work happened, create one.
